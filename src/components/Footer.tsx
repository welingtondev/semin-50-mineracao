...
const Footer = () => (
  <footer className="bg-semin-dark py-10 md:py-20 relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 relative z-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-10 mb-8 md:mb-12">
        <div>
          ...
          <p className="font-body text-xs md:text-sm text-white/40">Seminário de Mineração da UFBA</p>
        ...
        <div>
          ...
          <a href="mailto:semin@ufba.br" className="font-body text-xs md:text-sm text-white/40 hover:text-semin-yellow transition-colors flex items-center gap-2 py-0.5">
            <Mail className="h-3.5 w-3.5 md:h-4 md:w-4 shrink-0" /> semin@ufba.br
          </a>
      ...
      <div className="border-t border-white/5 pt-5 md:pt-6 text-center">
        <p className="font-body text-[10px] md:text-xs text-white/20">© 2025 SEMIN – Seminário de Mineração da UFBA. Todos os direitos reservados.</p>
      </div>
    </div>
  </footer>
);
