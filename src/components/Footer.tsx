...
const Footer = () => (
  <footer className="bg-semin-dark py-14 md:py-20 relative overflow-hidden">
    ...
    <a
      href="#hero"
      className="absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 bg-semin-yellow rounded-full flex items-center justify-center shadow-lg shadow-semin-yellow/30 hover:bg-semin-orange transition-colors hover:scale-110"
    >
    ...
    <div className="container mx-auto px-4 relative z-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
        <div>
          ...
          <p className="font-body text-sm text-white/40">Seminário de Mineração da UFBA</p>
        ...
        <div>
          <h4 className="font-body text-sm font-semibold text-white/60 uppercase tracking-wider mb-4">Links Rápidos</h4>
          <div className="flex flex-col gap-3">
            {footerLinks.map((l) => (
              <a key={l.href} href={l.href} className="font-body text-sm text-white/40 hover:text-semin-yellow transition-all duration-300 hover:translate-x-1">
                {l.label}
              </a>
            ))}
          </div>
        ...
        <div>
          <h4 className="font-body text-sm font-semibold text-white/60 uppercase tracking-wider mb-4">Contato</h4>
          <a href="mailto:semin@ufba.br" className="font-body text-sm text-white/40 hover:text-semin-yellow transition-colors flex items-center gap-2">
      ...
      <div className="border-t border-white/5 pt-6 text-center">
        <p className="font-body text-xs text-white/20">© 2025 SEMIN – Seminário de Mineração da UFBA. Todos os direitos reservados.</p>
      </div>
    </div>
  </footer>
);
